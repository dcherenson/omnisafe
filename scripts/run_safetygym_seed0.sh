...
SAVE_DIR="/home/$USER/saferl_project/results/safetygym_seed0_2M"
$PYTHON ~/saferl_project/scripts/train_ppolog.py     --env SafetyPointGoal1-v0     --seed 0     --total-steps 2000000     --cost-limit 25.0     --device cuda:0     --save-dir $SAVE_DIR
