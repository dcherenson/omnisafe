...
if __name__ == '__main__':
    _stamped('Starting RL Project 1 — Circle Benchmark...')
    eg = ExperimentGrid(exp_name='RL-Project-1-Circle')
    ...
    eg.add('algo', [
        ...
        'PPOLag',   # PPO + naive Lagrangian multiplier
        'TRPOLag',  # TRPO + naive Lagrangian multiplier
        'TRPO',     # baseline — natural gradient, no constraints
    ])
    ...
    eg.add('logger_cfgs:wandb_project', ['RL-Project-1-Circle'])
